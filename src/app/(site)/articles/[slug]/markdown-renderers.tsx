...
function MarkdownHeadingLevel4(props: ComponentPropsWithoutRef<"h4">) {
  return (
    <h4
...
function MarkdownHeadingLevel5(props: ComponentPropsWithoutRef<"h5">) {
  return <h5 className="text-base font-black text-cyan-600 mt-8 mb-3 tracking-wide" {...props} />;
}

function MarkdownHeadingLevel6(props: ComponentPropsWithoutRef<"h6">) {
